...
public class AudienceVM extends BaseVM {
    public final static String TAG = AudienceVM.class.getName();
...
//    }
    ...
    public void initRate() {
        ...
        Log.i(TAG, "initViews: " + a + ", " + b + ", " + c + ", " + d);

    }

    public void drawColumns(LinearLayout.LayoutParams paramsA,
                            LinearLayout.LayoutParams paramsB,
                            LinearLayout.LayoutParams paramsC,
                            LinearLayout.LayoutParams paramsD) {
        int maxHeight = (int) App.getInstance().getResources().getDimension(R.dimen.d_400);//100%
    ...
    private void updateColumn(int maxHeight, int i, int h,
                              LinearLayout.LayoutParams paramsA,
                              MutableLiveData<String> textView,
                              MutableLiveData<LinearLayout.LayoutParams> paramsData) {
        if (i <= h) {
            paramsA.height = i;
